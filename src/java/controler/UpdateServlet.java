 ...
 * @author Tyler
 */
@WebServlet(name = "UpdateServlet", urlPatterns = {"/updateServer"})
public class UpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                //get the form data and set up a Server object
        ...
        //create an UpdateQuery object and use it to update the server
